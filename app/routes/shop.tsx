// app/routes/shop/index.tsx
import { useState } from "react"; // <--- Import useState
// import { Link, type MetaFunction } from "react-router"; // <-- REMOVE THIS LINE
...
import { ProductCard } from "~/components/common/ProductCard/ProductCard"; // Adjust path as needed
...
export default function ShopPage() { // Renamed from 'shop' to 'ShopPage' for consistency and clarity
    return (
        <div className="bg-gray-50 py-8">
            <div className="container mx-auto px-4 md:px-8">
                {/* Breadcrumbs / Page Header */}
                <div className="mb-6">
                    <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Shop All Products</h1>
